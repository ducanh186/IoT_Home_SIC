/*
 * LIVINGROOM NODE 1 - Environmental Monitor & Safety System
 ...
 * 
 * MQTT TOPICS:
 * - home/livingroom/node1/temperature_sensor/value
 * - home/livingroom/node1/humidity_sensor/value
 * - home/livingroom/node1/gas_sensor/analog_value
 * - home/livingroom/node1/gas_sensor/status
 * - home/livingroom/node1/flame_sensor/alert
 * - home/livingroom/node1/led_system/status
 * - home/livingroom/node1/buzzer/status
 */
...
// ===== MQTT TOPICS =====
const char* LIVINGROOM_NODE1_TEMP_TOPIC = "home/livingroom/node1/temperature_sensor/value";
const char* LIVINGROOM_NODE1_HUMIDITY_TOPIC = "home/livingroom/node1/humidity_sensor/value";
const char* LIVINGROOM_NODE1_GAS_ANALOG_TOPIC = "home/livingroom/node1/gas_sensor/analog_value";
const char* LIVINGROOM_NODE1_GAS_STATUS_TOPIC = "home/livingroom/node1/gas_sensor/status";
const char* LIVINGROOM_NODE1_FLAME_TOPIC = "home/livingroom/node1/flame_sensor/alert";
const char* LIVINGROOM_NODE1_LED_STATUS_TOPIC = "home/livingroom/node1/led_system/status";
const char* LIVINGROOM_NODE1_BUZZER_TOPIC = "home/livingroom/node1/buzzer/status";
const char* SYSTEM_HEARTBEAT_TOPIC = "home/system/heartbeat";
const char* SYSTEM_STATUS_TOPIC = "home/system/status";

// ===== CLIENT ID =====
const char* CLIENT_ID = "ESP32_Livingroom_Node1_Monitor";
...
void setup() {
  Serial.begin(115200);
  Serial.println("\n🏠 LIVINGROOM NODE 1 - Environmental Monitor Starting...");
  
  initializeHardware();
  connectToWiFi();
  setupMQTT();
  
  Serial.println("✅ Livingroom Node 1 initialized successfully!");
...
void publishSensorData(const SensorData& data) {
  ...
  client.publish(LIVINGROOM_NODE1_TEMP_TOPIC, tempStr.c_str());
  
  // Humidity
  String humStr = String(data.humidity, 1);
  client.publish(LIVINGROOM_NODE1_HUMIDITY_TOPIC, humStr.c_str());
  
  // Gas analog value
  String gasAnalogStr = String(data.gasAnalogValue);
  client.publish(LIVINGROOM_NODE1_GAS_ANALOG_TOPIC, gasAnalogStr.c_str());
  ...
  client.publish(LIVINGROOM_NODE1_GAS_STATUS_TOPIC, gasStatus.c_str());
  
  // Fire alert
  String fireStatus = data.fireDetected ? "FIRE_DETECTED" : "NO_FIRE";
  client.publish(LIVINGROOM_NODE1_FLAME_TOPIC, fireStatus.c_str());
  ...
  client.publish(LIVINGROOM_NODE1_LED_STATUS_TOPIC, ledStatus.c_str());
  ...
  client.publish(LIVINGROOM_NODE1_BUZZER_TOPIC, buzzerStatus.c_str());
}
...
void displayReadings(const SensorData& data) {
  Serial.println("╔══════════════════════════════════════════════╗");
  Serial.println("║       🏠 LIVINGROOM NODE 1 - Monitor        ║");
  Serial.println("╠══════════════════════════════════════════════╣");
